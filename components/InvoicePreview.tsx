...
const InvoicePreview: React.FC<InvoicePreviewProps> = ({ data, settings }) => {
  ...
  return (
    <div className="bg-white text-slate-800 p-10 md:p-16 w-[1000px] mx-auto shadow-none print:shadow-none min-h-[1414px] flex flex-col font-dm relative overflow-hidden">
      ...
      <header className="flex justify-between items-start border-b-2 border-slate-100 pb-12 relative z-10">
        ...
        <div className="text-right space-y-4">
          ...
          <div className="pt-2">
            <span className={`text-[12px] font-bold px-5 py-2 rounded-full border-2 transition-colors ${
              data.status === 'PAID' ? 'bg-green-50 text-green-700 border-green-200' : 
